...
function HeartForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("❤️ Heart Donation Form Submitted!\n\nThank you for your generosity!");
  };
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-4 text-danger">❤️ Heart Donation Form</h2>
      <p>I’ve decided to donate my heart so that even after I’m gone, I can help someone live. Giving life is the greatest gift we can share.</p>
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-check mb-3">
          <input
            ...
            required
          />
          <label className="form-check-label">I confirm my willingness to donate my heart.</label>
        </div>

        <button type="submit" className="btn btn-danger me-3">Submit</button>
        <Link to="/donation/heart" className="btn btn-secondary">⬅ Back</Link>
      </form>
    </div>
  );
}
