...
function KidneyForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("💚 Kidney Donation Form Submitted!\nThank you!");
  };
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-4 text-success">💚 Kidney Donation Form</h2>
      <p>I’ve decided to donate my kidney so that even after I’m gone, I can help someone live. Giving life is the greatest gift we can share.</p>
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-check mb-3">
          ...
          <label className="form-check-label">I confirm my willingness to donate my kidney.</label>
        </div>
        <button type="submit" className="btn btn-success me-3">Submit</button>
        <Link to="/donation/kidney" className="btn btn-secondary">⬅ Back</Link>
      </form>
    </div>
  );
}
